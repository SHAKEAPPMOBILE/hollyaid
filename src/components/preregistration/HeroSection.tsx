        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 lg:gap-12 h-full">
          ...
          >
            ...
            <p className="mb-6 text-lg text-muted-foreground leading-relaxed text-pretty text-center lg:text-left">
              At Hollyaid, we want to make workplace wellness easy and accessible. We help employees connect with trusted holistic health
              specialists to improve balance and create happier teams throughout the world. Caring for your team’s well-being is simple,
